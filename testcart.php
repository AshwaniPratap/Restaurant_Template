...
<?php
session_start();
$connect = mysqli_connect("localhost", "root", "", "restweb");
    ...
    <a href="">
      <img class="gall-img" src="images/mnu2.jpg" alt="Smiley face" >
       ...
       <div class="container" style="width:700px;">
            <h3 align="center">Order your food</h3><br />
            <?php
            ...
            <div class="table-responsive">
                 <table class="table table-bordered">
                      ...
                      <tr>
                           ...
                           <td><a href="testcart.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                      </tr>
                      <?php
